...
public class ReporteHorarioGridGrupos extends Pantalla{
    ...
    public ReporteHorarioGridGrupos(){
       ...
       */
        ...
        tabp2.setHeader("REPORTES HORARIOS GRUPALES");
        ...
        yavirac.setStyle("text-align:center;position:absolute;top:262px;left:580px;");
       ...
       */
       ...
       // aut_docente.eliminarVacio();
        ...
        botPrint.setValue("IMPRIMIR REPORTE POR DOCENTES");
        botPrint.setIcon("ui-icon-print");
        botPrint.setMetodo("generarPDFdocentes");
        botPrint.setStyle("text-align:center;position:absolute;top:465px;left:460px;");
        Boton botPrintD = new Boton();
        botPrintD.setId("botPrintD");
        botPrintD.setValue("IMPRIMIR REPORTE POR CARRERAS");
        botPrintD.setIcon("ui-icon-print");
        botPrintD.setMetodo("generarPDFniveles");
        botPrintD.setStyle("text-align:center;position:absolute;top:520px;left:460px;");
        
        Boton botPrintLab = new Boton();
        botPrintLab.setId("botPrintLab");
        botPrintLab.setValue("IMPRIMIR REPORTE POR LABORATORIOS");
        botPrintLab.setIcon("ui-icon-print");
        botPrintLab.setMetodo("generarPDFlaboratorios");
        botPrintLab.setStyle("text-align:center;position:absolute;top:575px;left:437px;");
        ...
        vipdf_horario_do.setTitle("REPORTE DE HORARIOS POR DOCENTES");
        agregarComponente(vipdf_horario_do);
        
        vipdf_horario_al.setId("vipdf_horario_al");
        vipdf_horario_al.setTitle("REPORTE DE HORARIOS POR CARRERAS");
    ...
    public void generarPDFniveles() {
       if (com_periodo_academico.getValue()!= null && aut_mension.getValor() != null) {
                        ...
                        utilitario.addUpdate("vipdf_horario_al");
        } else {
            utilitario.agregarMensajeInfo("Seleccione el periodo académico y la carrera para generar el reporte", "");
        }    
        
    }
    public void generarPDFlaboratorios() {
        if (com_periodo_academico.getValue()!= null) {
            ///////////AQUI ABRE EL REPORTE
                        Map map_parametros = new HashMap();
                        map_parametros.put("p_periodo",Integer.parseInt(com_periodo_academico.getValue() + ""));
                        vipdf_horario_lab.setVisualizarPDF("rep_horario/rep_laboratorios_grupos.jasper", map_parametros);
