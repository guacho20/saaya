 ...
 */
public class SeguimientoCoordinador extends Pantalla {
    ...
    public SeguimientoCoordinador() {
        ...
        if (TienePermiso()) {
            ...
            tab_asignaciondocente.getColumna("ide_ypedpe").setNombreVisual("DOCENTE ASIGNADO");
            tab_asignaciondocente.getColumna("ide_ypedpe").setLectura(true);
            tab_asignaciondocente.getColumna("observacion_yincda").setNombreVisual("OBSERVACION");
            tab_asignaciondocente.getColumna("observacion_yincda").setLectura(true);
            //tab_asignaciondocente.setLectura(true);
            ...
            tab_docentealumno.setHeader("ALUMNO ASIGNADOS");
            ...
            tab_docentealumno.getColumna("ide_yaldap").setLectura(true);
            //tab_docentealumno.setLectura(true);
            ...
            tab_docenteseguimiento.setHeader("SEGUIMIENTO ALUMNOS");
            tab_docenteseguimiento.getColumna("ide_yindoa").setNombreVisual("COD. DOC");
            ...
            tab_docenteseguimiento.getColumna("ide_yindoa").setLectura(true);
            tab_docenteseguimiento.getColumna("fecha_contacto_yindos").setLectura(true);
            tab_docenteseguimiento.getColumna("novedad_yindos").setLectura(true);
            tab_docenteseguimiento.getColumna("contactado_yindos").setLectura(true);
            //tab_docenteseguimiento.setLectura(true);
