 ...
 * @author JHONPRODUCER
 */
public class RecordAcademicoEstudiante extends Pantalla {
    ...
    public RecordAcademicoEstudiante() {
        ...
        aut_alumno.setAutoCompletar(ser_alumno.getDatosAlumnosCodigo(utilitario.getVariable("ALUMNO")));
        aut_alumno.setValor(utilitario.getVariable("ALUMNO"));
        aut_alumno.setSize(75);
        aut_alumno.setDisabled(true);
        ...
        tab_cabecera.setCondicion("ide_yaldap="+utilitario.getVariable("ALUMNO"));
        ...
        tab_detalle.getColumna("observacion_ynodra").setVisible(false);
    ...
    public void selecionoAutocompletar() {
        tab_cabecera.setCondicion("ide_yaldap=" + "895");
        tab_cabecera.imprimirSql();
